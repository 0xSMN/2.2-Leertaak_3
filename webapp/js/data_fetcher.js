        ...
        rawFile.onreadystatechange = function ()
        {
            if(rawFile.readyState === 4)
            {
                if(rawFile.status === 200 || rawFile.status === 0)
                {
                    ...
                    $("#" + row).append('<td style="text-align: center">'+array_data_needed[2]+' °C</td>');
                    $("#" + row).append('<td style="text-align: center">'+array_data_needed[3]+' °C</td>');
                    $("#" + row).append('<td style="text-align: center">'+array_data_needed[7]+' km/h</td>');
                    $("#" + row).append('<td style="text-align: center">'+array_data_needed[8]+' cm</td>');
                    $("#" + row).append('<td style="text-align: center">'+array_data_needed[12]+'%</td>');
                }
            }
        };
        rawFile.send(null);
